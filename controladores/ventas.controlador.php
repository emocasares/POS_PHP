...
class ControladorVentas{
    ...
    static public function ctrObtenerVentaMasReciente(){

		$tabla = "ventas";

		$respuesta = ModeloVentas::mdlObtenerVentaMasReciente($tabla);
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($respuesta != "error"){
				...
				$ventas = ModeloVentas::mdlObtenerVentaMasReciente($tabla);

                foreach ($ventas as $key => $value) {}
                
                $codigoId = $value["codigo"];
